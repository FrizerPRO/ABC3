...
7 Сравнение размеров программ:
  Откмпелированная с регистрами и модификацией (Р и М): 16 448 байт
  Откоммпилированная без регистров без модификаций (0): 16 576 байт
  Откмпелированная с регистрами и модификацией + Ofast(Ofast): 18 032 байта
  Откмпелированная с регистрами и модификацией + Os(Os): 16 568 байт
  
8 Результаты временного прогона:
				Р и М			0	    Ofast		Os
  Тест 1:   	0.000001     1164294080 ns	  1174762811 ns   127172904 ns   174837865 ns
  Тест 2: 	0.0000005    2336002544 ns	  2358036360 ns   265288628 ns   351383712 ns
